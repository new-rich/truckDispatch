  ...
  <div class="main">
    ...
    <div class="table">
      <el-table :data="tableData" border size="large">
        <el-table-column fixed prop="logID" label="日志ID" min-width="2"  align="center">
...
<!--          </template>-->
        ...
        <el-table-column prop="name" label="操作人员" min-width="2"  align="center"/>
        <el-table-column prop="car_id" label="目标车辆编号" min-width="2"  align="center"/>
        <el-table-column prop="car_name" label="目标车辆名称" min-width="2"  align="center"/>
        <el-table-column prop="command" label="操作指令" min-width="4"  align="center"/>
        <el-table-column prop="startTime" label="操作开始时间" min-width="4"  align="center"/>
        <el-table-column prop="endTime" label="操作完成时间" min-width="3"  align="center"/>
...
const tableData = [
  ...
  },
  {
    ...
    car_name: '挖掘机#1',
    command: '挖掘机#1派往采场',
    startTime: '2022-05-25 16:00:00',
    endTime: '2022-05-25 17:00:00',
  },
]
</script>
